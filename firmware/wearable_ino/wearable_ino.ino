...
void setup() {
  ...
  //   ledBrightness = 0x0A (~1/3 of previous 0x1F) — reduced from the
  //     original 0x1F to lower peak current draw on the shared 3V3 rail,
  //     which was causing BLE radio brown-outs on the XIAO ESP32-S3.
  //     Still enough signal for finger-on-sensor HR detection.
  //   sampleAverage = 4
