...
import { askReportChat, buildGroupContext } from '@/lib/report-chat';
...
export async function POST(
  ...
  try {
    ...
    const context = await buildGroupContext(id, schoolId);
    if (!context) {
    ...
    console.error('[api/chat/group]', err);
